...
<html lang="pl">
  ...
  <body>
    ...
    <div id="wycieczki" class="container mb-5">
      ...
      <div class="row">
      <?php
        // Dynamiczne generowanie kart na podstawie danych obiektów
        foreach ($trips as $trip) 
        {
            echo '<div class="col-12 col-sm-6 col-lg-3">';
              echo '<div class="card">';
              echo '<img src="img/' . $trip->getImg() . '" class="card-img-top" alt="...">';
                echo '<div class="card-body">';
                echo '<h5 class="card-title">' . $trip->getName() . '</h5>';
                echo '<p class="card-text">' . $trip->getDescription() . '</p>';
